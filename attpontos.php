...
$sql = "SELECT aposta.idpartida,aposta.idusers,aposta.mandante as am,aposta.visitante as av,aposta.pontosporjogo,partida.mandante as pm,partida.visitante as pv FROM bolao.aposta INNER JOIN bolao.partida ON aposta.idpartida = partida.idpartida;";
